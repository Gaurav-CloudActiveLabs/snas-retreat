...
export default function HotelBooking() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    router.push(
      `/primary-booking?checkIn=${formData.checkIn}&checkOut=${formData.checkOut}&adults=${formData.adults}&children=${formData.children}&roomType=${formData.roomType}&mealOption=${mealOption}&extraRooms=${extraRooms}&=extraBeds${extraBeds}`,
      { scroll: false }
    );
    // router.push({
    //   pathname: "/primary-booking",
    //   query: {
