          ...
          <div className="flex flex-col sm:flex-row gap-4 rounded-lg p-4">
            ...
            <div className="flex items-start space-x-4 flex-1">
              ...
              <div>
                ...
                <p className="text-black text-[16px] lg:text-[18px]">offering ample space for two adults</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4 flex-1">
              ...
              <div>
                ...
                <p className="font-bold text-[#A75F37] text-[30px] lg:text-[35px]">Queen-sized</p>
                <p className="text-black text-[16px] lg:text-[18px] whitespace-normal lg:whitespace-nowrap">
                  or twin beds with premium quality linens and pillows
                </p>
              </div>
            </div>
          </div>
